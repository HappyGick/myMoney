    ...
    return (
      <div className ="bg">
        <div className="mainHome">
          ...
          <button className="glow-button" onClick={ goSalPresSol }> Saldo de Todos los Prestamos Recibidos </button>
          <button className="glow-button" onClick={ goSalPresOto }> Saldo de Todos los Prestamos Otorgados </button> <br />
